    ...
    def check_db_exists():
        ...
        if mycon.is_connected() == False:
            ...
            try:
                ...
                cursor.execute('create database connect4;')
                cursor.execute('use connect4;')
...
def PlayerLogin():
    ...
    if bool(player1) == True and bool(player2) == False and player == player1:
        print(f'{player} has already logged in. Please use another account.')
        return False

    elif bool(player1) == False and bool(player2) == True and player == player2:
        print(f'{player} has already logged in. Please use another account.')
        return False
        ...
        try:
            ...
            if a and bool(a) == True: 
                ...
                if a[0] == password: 
                    ...
                    print('Incorrect Login. Please recheck Password.')
        except: 
...
import mysql.connector as SQL, time, sys, os
#print(dir(SQL))
#help(SQL)
...
sql_host = 'localhost'#input('Enter SQL Server Host name: ')
sql_user = 'root'#input('Enter SQL Server Username: ')
sql_password = 'password'#input('Enter SQL Server Password: ')
    ...
    if main_menu in ('1', '2', '3', '4'):
        ...
        if main_menu == '1': #SINGLE PLAYER (both AI and Guest are there.)
            ...
            while sub_menu not in ('1', '2', '3', '4', '5') or sub_over == False:
                ...
                elif sub_menu == '3': #2 PLAYER GAME
                    if bool(player1) == True and bool(player2) == True:
                        ...
                        print('Two players needed to play this. Please Log-In or play Single Player.')
